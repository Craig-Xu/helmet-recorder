...
Mac: 
#tty.usbserial-5B0B0295361
`$ python3 main.py --port /dev/tty.usbserial-5B0B0295361 --bps 460800 `

`$ python3 main.py --port /dev/tty.usbserial-5B0B0295361 --bps 460800 --dbg `
